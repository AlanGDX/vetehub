    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-[#eef2ff] dark:bg-blue-100 p-4 rounded-full">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-[#ecfdf3] dark:bg-green-100 p-4 rounded-full">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-[#f3e8ff] dark:bg-purple-100 p-4 rounded-full">
