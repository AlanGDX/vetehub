...
@section('title', 'Editar Articulo - VeteHub')
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('products.update', $product) }}" class="space-y-5">
            ...
            <div class="flex items-center">
                <input id="is_active" name="is_active" type="checkbox" value="1" class="h-4 w-4 text-blue-600" {{ old('is_active', $product->is_active) ? 'checked' : '' }}>
